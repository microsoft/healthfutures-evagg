...
def test_find_ids_for_gene(mocker, entrez_client):
    ...
    20060628//EN" "https://eutils.ncbi.nlm.nih.gov/eutils/dtd/20060628/esearch.dtd">\n<eSearchResult><Count>48</Count><\
    RetMax>1</RetMax><RetStart>0</RetStart><IdList>\n<Id>8491582</Id>\n</IdList><TranslationSet/><TranslationStack>   <\
    TermSet>    <Term>RGSL1[All Fields]</Term>    <Field>All Fields</Field>    <Count>48</Count>    <Explode>\
    N</Explode>\
    </TermSet>   <OP>GROUP</OP>  \
    </TranslationStack><QueryTranslation>RGSL1[All Fields]</QueryTranslation></eSearchResult>\n'
...
def test_generate_citation(entrez_client):
    ...
    . 2021
    Journal Abbr.
    DOI: 10.1234/abcd5678
    PMCID: PMC1234567
    PMID: 12345678
    """
    # Call the _generate_citation method and check the result
    result = library._generate_citation(text_info)
    expected_result = ("Smith (2021), Journal Abbr, 10.1234/abcd5678", "10.1234/abcd5678", "PMC1234567")
