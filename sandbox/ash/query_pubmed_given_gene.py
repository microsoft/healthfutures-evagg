...
#     xmls = (
#         "https://hanoverdev.blob.core.windows.net/data/20200314_pmc_html/analysis/updates_20210803/20210803/entities/"
#     )
#     pass
...
# def find_ids_for_gene(query: str):
...
#         paper = Paper(id=doi, citation=citation, abstract=abstract, pmid=pmid)  # make new Paper obj per entry
